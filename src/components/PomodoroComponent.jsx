...
const PomodoroComponent = () => {
  ...
  const progressPercentage = ((timerTypes[timerType] - secondsLeft) / timerTypes[timerType]) * 100;

  return (
    <div className="flex items-center justify-center">
      <div
        className="relative inline-block p-1 rounded-[20px]"
        style={{ background: `conic-gradient(#ebb305 ${progressPercentage}%, transparent 0)` }}
      >
